...
namespace api.usermanagement.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> LoginWithFromData([FromForm] string username, [FromForm] string password)
        {
            try
            {
        ...
        public async Task<IActionResult> LoginWithParam(string username, string password)
        {
            try
            {
                modelLogin login = new modelLogin();
